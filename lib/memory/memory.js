...
class WasmBoyMemoryService {
  ...
  loadState(saveState) {
    const loadStateTask = async () => {
      ...
      saveStateMemory.cartridgeRam = getSaveStateMemoryArray(saveStateMemory.cartridgeRam, 'cartridgeRam');
      saveStateMemory.gameBoyMemory = getSaveStateMemoryArray(saveStateMemory.gameBoyMemory, 'gameBoyMemory');
      saveStateMemory.wasmBoyPaletteMemory = getSaveStateMemoryArray(saveStateMemory.wasmBoyPaletteMemory, 'wasmBoyPaletteMemory');
      saveStateMemory.wasmBoyInternalState = getSaveStateMemoryArray(saveStateMemory.wasmBoyInternalState, 'wasmBoyInternalState');

      const workerMemoryObject = {};
      workerMemoryObject[MEMORY_TYPE.CARTRIDGE_RAM] = saveStateMemory.cartridgeRam.buffer;
      workerMemoryObject[MEMORY_TYPE.GAMEBOY_MEMORY] = saveStateMemory.gameBoyMemory.buffer;
      workerMemoryObject[MEMORY_TYPE.PALETTE_MEMORY] = saveStateMemory.wasmBoyPaletteMemory.buffer;
      workerMemoryObject[MEMORY_TYPE.INTERNAL_STATE] = saveStateMemory.wasmBoyInternalState.buffer;
