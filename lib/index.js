...
import { screenshot } from './graphics/screenshot';
import {
  runNumberOfFrames,
  runWasmExport,
...
export const WasmBoy = {
  ...
  getAudioDiagnostics: () => {
    return WasmBoyAudio.getDiagnostics();
  },
  ...
  getJoypadState: WasmBoyController.getJoypadState.bind(WasmBoyController),
  setJoypadState: WasmBoyController.setJoypadState.bind(WasmBoyController),
  setVirtualJoypadState: WasmBoyController.setVirtualJoypadState.bind(WasmBoyController),
  clearVirtualJoypadState: WasmBoyController.clearVirtualJoypadState.bind(WasmBoyController),
